document.write('<div class="w3-left w3-sidebar w3-bar-block w3-border w3-card w3-dark-grey" style="width:25%"><a href="/index.html" class="w3-bar-item w3-button w3-black">Home</a>');
...
document.write('<button class="w3-bar-item w3-btn w3-border w3-light-grey" onclick="darkMode()">Toggle dark mode</button></div><div style="margin-left:25%">');
function darkMode() {
