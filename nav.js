...
document.write('<button class="w3-bar-item w3-btn w3-hide-large" onclick="w3_close()">Close &times;</button>');
...
document.write('<button class="w3-btn w3-xlarge" onclick="w3_open()">&#9776;</button>')
function darkMode() {
